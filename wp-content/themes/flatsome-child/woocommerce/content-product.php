...
if(is_user_logged_in() && current_user_can("wholesale_buyer")){
	$product_price_without_tax = get_post_meta($post->ID, "wholesale_price", true);
	//echo $product_price_without_tax;
	
} else {
	$product_price_with_tax = $product->get_price_including_tax();
	//echo $product_price_with_tax;
}
