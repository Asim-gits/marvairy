...
class IgniteWoo_Wholesale_Pricing_Plus_Rules_Admin {
	...
	public function on_product_write_panel_tabs() {
		...
		?>
		<li class="pricing_tab dynamic_pricing_options"><a href="#dynamic_wholesale_pricing_data"><?php _e( 'Wholesale Discounts', 'ignitewoo_wholesale' ); ?></a></li>
		<?php
	}
				...
				<ul class="list-column">        
					...
					<li>
						<label for="variation_<?php echo $variation_id; ?>" class="selectit"> 
							<input <?php echo $variation_checked; ?> type="checkbox" id="variation_<?php echo $variation_id . $this->z; ?>" name="pricing_rules[<?php echo $name; ?>][variation_rules][args][variations][]" value="<?php echo $variation_id; ?>" /> <?php echo get_the_title( $variation_id); ?>
						</label>
					</li>
